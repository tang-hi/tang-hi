...
- [tang-hi/clangd-mcp](https://github.com/tang-hi/clangd-mcp) - A mcp for clangd (2 days ago)
...
- [WECENG/ticket-purchase](https://github.com/WECENG/ticket-purchase) - 大麦自动抢票，支持人员、城市、日期场次、价格选择 (1 day ago)
- [XTXMarkets/ternfs](https://github.com/XTXMarkets/ternfs) - A distributed file system (1 day ago)
- [shap/shap](https://github.com/shap/shap) - A game theoretic approach to explain the output of any machine learning model. (2 days ago)
