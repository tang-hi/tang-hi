...
- [tang-hi/simplefst](https://github.com/tang-hi/simplefst) - A tiny, header-only finite state transducer (FST) implementation (3 days ago)
...
- [xiaguan/pegaflow](https://github.com/xiaguan/pegaflow) (1 day ago)
